...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        return view('admin.dashboard', compact('lastApprovetOutpass', 'lastRejectedOutpass', 'lastPendingOutpass', 'totalOutpass', 'totalAcceptedOutpass', 'totalRejectedOutpass', 'allOutpass'));
    }
