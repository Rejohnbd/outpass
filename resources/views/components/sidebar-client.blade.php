<div class="main-sidebar-body main-body-1">
    ...
    <ul class="menu-nav nav">
        ...
        <li class="nav-item @if(Request::is('outpass*')) active show @endif">
            <a class="nav-link with-sub @if(Request::is('outpass*')) active @endif" href="javascript:;">
                <svg class="sidemenu-icon menu-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
            ...
            <ul class="nav-sub">
                ...
                <li class="nav-sub-item">
                    <a class="nav-sub-link" href="{{ route('outpass.index') }} ">All Outpass</a>
                </li>
                <li class="nav-sub-item">
                    <a class="nav-sub-link" href="{{ route('outpass.create') }}">New Outpass</a>
                </li>
            </ul>
        </li>
    </ul>
