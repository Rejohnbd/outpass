     ...
     <div class="main-menu main-sidebar main-sidebar-sticky side-menu">
         <div class="main-sidebar-header main-container-1 active">
             <div class="sidemenu-logo">
                 <a class="main-logo" href="@if(auth()->user()->user_type == 'admin'){{ route('admin-dashboard') }} @elseif(auth()->user()->user_type == 'subadmin'){{ route('admindashboard') }}  @elseif(auth()->user()->user_type == 'incharge'){{ route('incharge-dashboard') }} @else{{ route('dashboard') }}@endif">
             ...
             @include('components.sidebar-subadmin')
