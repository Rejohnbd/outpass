             ...
             <div class="main-sidebar-body main-body-1">
                 ...
                 <ul class="menu-nav nav">
                     <li class="nav-item">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Dashboards</a></li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="index.html">Dashboard-1</a>
                             </li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="index2.html">Dashboard-2</a>
                             </li>
                         </ul>
                     </li>
                     <li class="nav-item">
                     ...
                     <li class="nav-item">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Crypto Currencies</a></li>
                             <li class="nav-sub-item">
                             ...
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="crypto-market.html">Market Capital</a>
                             </li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="crypto-wallet.html">My Wallet</a>
                             </li>
                             <li class="nav-sub-item">
                     ...
                     <li class="nav-item">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Elements</a></li>
                             <li class="nav-sub-item">
                             ...
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="tabs.html">Tabs</a>
                             </li>
                             <li class="nav-sub-item">
                     ...
                     <li class="nav-item">
                         <a class="nav-link with-sub" href="javascript:;">
                             ...
                             <i class="angle fe fe-chevron-right"></i></a>
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Advanced UI</a></li>
                             <li class="nav-sub-item">
                             ...
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="notifications.html">Notifications</a>
                             </li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="treeview.html">Treeview</a>
                             </li>
                             <li class="nav-sub-item">
                     ...
                     <li class="nav-item submenu-style">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Apps</a></li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="widgets.html">Widgets</a>
                             </li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link sub-with-sub" href="javascript:;">
                             ...
                             <li class="nav-sub-item">
                                 ...
                                 <ul class="sub-nav-sub">
                                     <li class="nav-sub-item">
                                         <a class="nav-sub-link" href="blog.html">Blog Page</a>
                                     </li>
                                     <li class="nav-sub-item">
                             ...
                             <li class="nav-sub-item">
                                 ...
                                 <ul class="sub-nav-sub">
                                     <li class="nav-sub-item">
                                         <a class="nav-sub-link" href="filemanager.html">File Manager</a>
                                     </li>
                                     <li class="nav-sub-item">
                                         <a class="nav-sub-link" href="filemanager-list.html">File Manager List</a>
                                     </li>
                                     <li class="nav-sub-item">
                                         <a class="nav-sub-link" href="file-details.html">File Details</a>
                                     </li>
                                     <li class="nav-sub-item">
                                         <a class="nav-sub-link" href="file-attachment.html">File Attachments</a>
                                     </li>
                                 </ul>
                             </li>
                         </ul>
                     ...
                     <li class="nav-item">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Tables</a></li>
                             <li class="nav-sub-item">
                     ...
                     <li class="nav-item">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Icons</a></li>
                             <li class="nav-sub-item">
                     ...
                     <li class="nav-item">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Forms</a></li>
                             <li class="nav-sub-item">
                             ...
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="form-sizes.html">Form Element Sizes</a>
                             </li>
                             <li class="nav-sub-item">
                             ...
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="form-editor.html">Form Editor</a>
                             </li>
                         </ul>
                     </li>
                     <li class="nav-item">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Charts</a></li>
                             <li class="nav-sub-item">
                     ...
                     <li class="nav-item submenu-style">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Pages</a></li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link sub-with-sub" href="javascript:;">
                             ...
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="notifications-list.html">Notifications List</a>
                             </li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="aboutus.html">About Us</a>
                             </li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="settings.html">Settings</a>
                             </li>
                             <li class="nav-sub-item">
                             ...
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="switcher-2.html">Switcher Page</a>
                             </li>
                         </ul>
                     </li>
                     <li class="nav-item submenu-style">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Submenu</a></li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link" href="javascript:;">Level-1</a>
                             </li>
                             <li class="nav-sub-item">
                                 <a class="nav-sub-link sub-with-sub" href="javascript:;">
                                 ...
                                 <ul class="sub-nav-sub">
                                     <li class="nav-sub-item">
                                         <a class="nav-sub-link" href="javascript:;">Level-2.1</a>
                                     </li>
                                     <li class="nav-sub-item">
                                         <a class="nav-sub-link sub-with-sub" href="javascript:;">
                                         ...
                                         <ul class="sub-nav-sub">
                                             <li class="nav-sub-item">
                                                 <a class="nav-sub-link" href="javascript:;">Level-2.2.1</a>
                                             </li>
                                             <li class="nav-sub-item">
                                                 <a class="nav-sub-link" href="javascript:;">Level-2.2.2</a>
                                             </li>
                                         </ul>
                                     </li>
                                 </ul>
                     ...
                     <li class="nav-item">
                         ...
                         <ul class="nav-sub">
                             <li class="side-menu-label1"><a href="javascript:;">Utilities</a></li>
                             <li class="nav-sub-item">
