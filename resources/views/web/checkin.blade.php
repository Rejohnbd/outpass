                    ...
                    <div class="container-fluid">
                        <div class="row row-sm">
                            <div class="card-body main-profile-overview mt-3 mb-3">
                                ...
                                <h2 class="text-start mb-2 text-center">CheckIn Screen</h2>
                                <p class="mb-4 text-muted tx-13 ms-0 text-center">Enter Outpass and Submit for Checkin</p>
