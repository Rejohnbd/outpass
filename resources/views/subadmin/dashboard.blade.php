            ...
            <div class="d-flex">
                <div class="justify-content-center">
                    <button type="button" class="btn btn-white btn-icon-text my-2 me-2">
                        ...
                        <span>Hostel & Floor: {{Auth::user()->subadmin->hostel->short_code }}</span>
                    </button>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <a href="{{ route('outpass-approval', $item->outpass_id) }}" class="btn ripple btn-outline-warning btn-sm">Pending</a>
                                            @endif
                                        </td>
                                        <td>{{ $item->duration }}</td>
                                        <td></td>
